...
@dataclass
class EulerAncestralDiscreteSchedulerOutputStatic(BaseOutput):
    """
...
class EulerAncestralDiscreteSchedulerStatic(SchedulerMixin, ConfigMixin):
    """
    ...
    def scale_model_input(
            ...
            input_sigmas:paddle.Tensor) -> paddle.Tensor:
        """
    ...
    def step(
        ...
        input_sigmas: paddle.Tensor,
        noise: paddle.Tensor,
    ) -> Union[EulerAncestralDiscreteSchedulerOutputStatic, Tuple]:
        """
        ...
        sigma_from = input_sigmas[0]
        sigma_to = input_sigmas[1]
